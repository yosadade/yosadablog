      ...
      <Container>
        <div className="flex items-center">
          ...
          <div className="lg:w-2/12 w-6/12">
            {/* <Link> */}
              <a className="flex items-center justify-center lg:justify-start">
                <div className="w-10 h-10 bg-gray-500 rounded flex items-center justify-center mr-4 shadow-2xl">Y</div>
                Yosadade
              </a>
            {/* </Link> */}
          </div>
          ...
          <div className={`lg:w-7/12 w-full bg-gradient-to-b from-gray-600 to-gray-900 lg:bg-none fixed lg:static top-0 h-full lg:h-auto p-10 lg:p-0 transition-all ${offcavnas ? 'left-0' : '-left-full'}`}>
            ...
            <li><Link href="/diary"><a className="hover:underline">Diary</a></Link></li>
              <li><Link href="/inspiration"><a className="hover:underline">Inspiration</a></Link></li>
              <li><Link href="/programming"><a className="hover:underline">Programming</a></Link></li>
